            ...
            <div className="mx-auto w-full max-w-[420px]">
              ...
              <form className="space-y-4" method="post" onSubmit={handleSubmit}>
                <div className="space-y-1.5">
                  <label htmlFor="signup-name" className="ds-app-label">
                    Full name
                  </label>
                  <input
                    id="signup-name"
                ...
                <div className="space-y-1.5">
                  <label htmlFor="signup-email" className="ds-app-label">
                    Work email
                  </label>
                  <input
                    id="signup-email"
                ...
                <div className="space-y-1.5">
                  <label htmlFor="signup-password" className="ds-app-label">
                    Password
                  </label>
                  <input
                    id="signup-password"
              ...
              <p className="ds-app-kicker mt-8 px-4 text-center">
          ...
          <div className="dot-grid border-ds-outline relative hidden flex-1 items-center justify-center overflow-hidden border-l p-12 lg:flex">
            <div className="border-ds-outline relative z-10 flex h-[480px] w-full max-w-lg scale-110 flex-col overflow-hidden rounded-ds-lg border bg-ds-surface shadow-xl shadow-zinc-300/50">
              <div className="bg-ds-neutral border-ds-outline flex items-center gap-2 border-b px-4 py-3">
                ...
                <div className="ds-app-kicker border-ds-outline mx-auto rounded border bg-ds-surface px-12 py-1">
                  mystore.shopify.com
                </div>
              </div>
              ...
              <div className="border-ds-outline absolute bottom-6 right-6 z-10 flex h-[320px] w-72 flex-col overflow-hidden rounded-ds-xl border bg-ds-surface shadow-2xl">
                ...
                <div className="flex flex-grow flex-col space-y-4 bg-ds-surface p-4">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="ds-app-body-muted rounded-2xl rounded-tl-none bg-zinc-100 px-3 py-2">
                      Hi there! 👋 How can I help you with your order today?
                    </div>
                  </div>
                  <div className="flex flex-col items-end gap-1.5">
                    <div className="bg-ds-primary flex min-h-[34px] items-center rounded-2xl rounded-br-none px-4 py-2.5 text-sm font-medium text-ds-on-primary shadow-sm">
                      <SignupTypingPreview />
                    </div>
            ...
            <div className="absolute bottom-8 text-center">
              <p className="ds-app-kicker font-bold opacity-60">
