...
function EmbedCaption() {
  return (
    <div className="mt-4 flex max-w-[400px] items-center justify-center gap-2.5 text-center">
      <span
        className="demo-embed-caption-icon flex size-8 shrink-0 items-center justify-center rounded-full border shadow-ds-sm ring-2 ring-ds-surface"
        aria-hidden
      >
      ...
      <p className="text-left text-[12px] leading-snug text-ds-on-surface-variant">
