...
function ChatRelyFallbackLogo({ className }: { className?: string }) {
  return (
    ...
    if (size === "header") {
      return (
        <div className={headerShellClass}>
          <ChatRelyFallbackLogo className="block h-[19px] w-auto max-w-none object-contain" />
        </div>
      );
    }
    if (size === "welcome") {
      return (
        <div className={welcomeShellClass}>
          <ChatRelyFallbackLogo className="relative z-[1] size-full rounded-lg object-contain p-1" />
        </div>
      );
    }
    return (
      <div className={bubbleShellClass}>
        <ChatRelyFallbackLogo className="relative z-[1] size-full object-contain p-0.5" />
      </div>
    );
  }
